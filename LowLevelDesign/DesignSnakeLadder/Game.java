...
public class Game {
    ...
    private void addPlayers() {
        Player player1 = new Player("Shivani", 0);
        Player player2 = new Player("Bhavesh", 0);
    ...
    public void startGame(){
        ...
        System.out.println("Snake and Ladder Game WINNER IS:" + winner.id);
    }
    ...
    private int jumpCheck (int playerNewPosition) {
        ...
        if(cell.jump != null && cell.jump.start == playerNewPosition) {
            String jumpBy = (cell.jump.start < cell.jump.end) ? "Jump from Ladder" : "Cut by Snake";
